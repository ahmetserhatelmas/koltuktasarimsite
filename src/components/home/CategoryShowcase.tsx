  ...
  return (
    <section id="kategoriler" className="scroll-mt-28 bg-[var(--surface)] py-12 sm:py-16">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionHeading title="Öne çıkan kategoriler" subtitle="Koltuk Dünyam klasörlerinize göre ayrılmış vitrin" />
                ...
                >
                  <div className="relative aspect-[3/4] w-full bg-zinc-100">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-5">
                      <p className="text-lg font-bold text-white sm:text-xl">{cat.label}</p>
                      <p className="mt-1 text-xs text-white/85 sm:text-sm">{cat.tagline}</p>
                    </div>
                  </div>
                </Link>
              ))}
